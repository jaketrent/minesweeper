...
mm.controller "GameCtrl", ["$scope", "$http", ($scope, $http) ->
  ...
  Game = ->
    ...
    clearSurroundingCells: (cell) ->
      ...
      # W
      clearIfValid.call this, @cellAt(@prevCol(cell.x), cell.y)
      
      # E
      clearIfValid.call this, @cellAt(@nextCol(cell.x), cell.y)
      
      # N
      clearIfValid.call this, @cellAt(cell.x, @upRow(cell.y))
      
      # S
      clearIfValid.call this, @cellAt(cell.x, @downRow(cell.y))
      
      # NW
      clearIfValid.call this, @cellAt(@prevCol(cell.x), @upRow(cell.y))
      
      # NE
      clearIfValid.call this, @cellAt(@nextCol(cell.x), @upRow(cell.y))
      
      # SW
      clearIfValid.call this, @cellAt(@prevCol(cell.x), @downRow(cell.y))
      
      # SE
      clearIfValid.call this, @cellAt(@nextCol(cell.x), @downRow(cell.y))
